      ...
      <div className="border-b bg-card">
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <Button asChild variant="default" className="bg-neon-green text-black hover:bg-field-green">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {isLoading ? (
            Array.from({ length: 6 }).map((_, i) => (
              <Card key={i} className="bg-turf-card border-turf-border animate-pulse">
                <CardHeader>
            ...
            squads.map((squad) => {
              ...
              return (
                <Card key={squad.id} className="bg-turf-card border-turf-border hover:shadow-lg transition-shadow">
                  <CardHeader>
                    <CardTitle className="text-foreground flex items-center justify-between">
                      <span>{squad.name}</span>
                      <Badge variant="outline" className="bg-neon-green text-black">
                        ...
                        <div className="space-y-1 max-h-64 overflow-y-auto">
                          {squad.slots
                            ...
                            .map((slot) => {
                              ...
                              return (
                                <div key={`${squad.id}-${slot.positionKey}`} className="flex items-center justify-between p-2 bg-background rounded border">
